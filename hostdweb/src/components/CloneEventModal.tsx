...
const CloneEventModal: React.FC<CloneEventModalProps> = ({
    ...
    const handleClone = async () => {
        ...
        try {
            ...
            const { doc, getDoc, collection, addDoc, Timestamp } = await import('firebase/firestore');
            ...
            const clonedEventData = {
                ...
                published: !options.editBeforePublish,
                viewCount: 0,
                ticketsSold: 0,
                totalRevenue: 0,
                clonedFrom: eventId,
            ...
            console.log('Creating cloned event in Firestore...');
