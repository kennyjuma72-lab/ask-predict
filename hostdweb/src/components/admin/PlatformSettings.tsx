/**
 * PLATFORM SETTINGS - Main Settings Page
        ...
        <div className="p-6">
            ...
            <div className="flex gap-2 mb-6 border-b border-gray-200">
                <button
                    ...
                    className={`px-4 py-2 font-medium ${activeTab === 'fees'
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium ${activeTab === 'features'
                            ? 'text-blue-600 border-b-2 border-blue-600'
                            : 'text-gray-600'
                        }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium ${activeTab === 'maintenance'
                            ? 'text-blue-600 border-b-2 border-blue-600'
                            : 'text-gray-600'
                        }`}
                >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setSettings({
                                    ...settings,
                                    fees: { ...settings.fees, platformFee: parseFloat(e.target.value) }
                                })}
