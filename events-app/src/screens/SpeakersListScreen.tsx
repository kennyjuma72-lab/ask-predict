...
export default function SpeakersListScreen({ navigation, route }: SpeakersListScreenProps) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const unsubscribe = onSnapshot(
        ...
        (eventDoc) => {
          try {
            ...
            showToast('Failed to process event data', 'error');
            setLoading(false);
          }
        },
        (error) => {
          ...
          getDoc(eventDocRef)
            ...
            .catch((fallbackError) => {
              ...
              showToast('Failed to load event data. Please check your connection', 'error');
              setLoading(false);
            });
        }
      );
      ...
      showToast('Failed to connect to event data', 'error');
      setLoading(false);
    }
