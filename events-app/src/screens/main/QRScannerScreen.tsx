...
export const QRScannerScreen: React.FC = () => {
    ...
    const handleCheckIn = async () => {
        ...
        try {
            ...
            if (success) {
                showToast(`${validationResult.ticket.userName || 'Attendee'} has been checked in successfully!`, 'success');
                handleDismiss();
            } else {
                showToast('Failed to check in attendee. Please try again.', 'error');
            }
        } catch (error) {
