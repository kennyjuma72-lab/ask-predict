...
import { collection, query, getDocs, where, orderBy, updateDoc, doc, getDoc, Timestamp } from 'firebase/firestore';
...
export default function TicketsPage() {
    ...
    const handleBulkAction = async () => {
        ...
        try {
            ...
            toast(`Successfully ${bulkAction}ed ${selectedTickets.size} ticket(s)`, 'success');
        } catch (error) {
            console.error('Error performing bulk action:', error);
            toast('Failed to perform bulk action', 'error');
        }
    };
